...
- **Point Cloud Mamba (PCM): Point Cloud Learning via State Space Model** - March 29, 2024, arXiv [[Paper](https://arxiv.org/abs/2403.00762)] [[Code](https://github.com/SkyworkAI/PointCloudMamba)] ![Stars](https://img.shields.io/github/stars/SkyworkAI/PointCloudMamba)
- **Mamba3D: 3D Point Cloud Analysis using Advanced Mamba Techniques** - March 22, 2024, arXiv [[Paper](https://arxiv.org/abs/2403.07654)] [[Code](https://github.com/mamba-lab/Mamba3D)] ![Stars](https://img.shields.io/github/stars/mamba-lab/Mamba3D)
- **Point Cloud Mamba (PCM): Point Cloud Learning via State Space Model** - March 29, 2024, arXiv [[Paper](https://arxiv.org/abs/2403.00762)] [[Code](https://github.com/SkyworkAI/PointCloudMamba)] ![Stars](https://img.shields.io/github/stars/SkyworkAI/PointCloudMamba)
...
- **3DMambaIPF: Interleaved Point Fusion for Point Cloud Denoising with Mamba** - March 14, 2024, arXiv [[Paper](https://arxiv.org/abs/2403.05124)] [[Code](https://github.com/3DMambaIPF/3DMambaIPF)] ![Stars](https://img.shields.io/github/stars/3DMambaIPF/3DMambaIPF)
...
- **SSM-Based Event Vision: Efficient Visual Object Tracking using State Space Model** - June 19, 2024, arXiv [[Paper](https://arxiv.org/abs/2406.16548)] [[Code](https://github.com/Event-AHU/SSM-Based-Event-Vision)] ![Stars](https://img.shields.io/github/stars/Event-AHU/SSM-Based-Event-Vision)
...
- **SSM Diffusion: Diffusion Models for Video Synthesis with Mamba Integration** - April 18, 2024, arXiv [[Paper](https://arxiv.org/abs/2404.08562)] [[Code](https://github.com/SSM-Diffusion/SSM-Diffusion)] ![Stars](https://img.shields.io/github/stars/SSM-Diffusion/SSM-Diffusion)
...
- **HARMamba: Hierarchical Attention Mamba for Video Understanding** - April 8, 2024, arXiv [[Paper](https://arxiv.org/abs/2404.06589)] [[Code](https://github.com/HARMamba/HARMamba)] ![Stars](https://img.shields.io/github/stars/HARMamba/HARMamba)
...
- **SSSMLV: Sequential State Space Modeling for Long Videos** - March 1, 2024, arXiv [[Paper](https://arxiv.org/abs/2403.01015)] [[Code](https://github.com/SSSMLV/SSSMLV)] ![Stars](https://img.shields.io/github/stars/SSSMLV/SSSMLV)
- **ViS4mer: Video Synthesis Framework with Mamba-Based Attention Mechanism** - February 15, 2024, arXiv [[Paper](https://arxiv.org/abs/2402.04855)] [[Code](https://github.com/ViS4mer-Lab/ViS4mer)] ![Stars](https://img.shields.io/github/stars/ViS4mer-Lab/ViS4mer)
...
- **SS-Mamba: Spatial-Spectral State Space Model for Hyperspectral Image Classification** - April 5, 2024, arXiv [[Paper](https://arxiv.org/abs/2404.09146)] [[Code](https://github.com/SS-Mamba/SS-Mamba)] ![Stars](https://img.shields.io/github/stars/SS-Mamba/SS-Mamba)
- **3DSS-Mamba: 3D-Spectral-Spatial Mamba for Hyperspectral Image Classification** - March 21, 2024, arXiv [[Paper](https://arxiv.org/abs/2403.12456)] [[Code](https://github.com/3DSS-Mamba/3DSS-Mamba)] ![Stars](https://img.shields.io/github/stars/3DSS-Mamba/3DSS-Mamba)
- **S2Mamba: A Spatial-spectral State Space Model for Hyperspectral Image Classification** - March 19, 2024, arXiv [[Paper](https://arxiv.org/abs/2403.11675)] [[Code](https://github.com/S2Mamba/S2Mamba)] ![Stars](https://img.shields.io/github/stars/S2Mamba/S2Mamba)
...
- **LE-Mamba: Local Enhancement and Mamba-based Architecture for Remote Sensing Image Super-Resolution** - February 21, 2024, arXiv [[Paper](https://arxiv.org/abs/2402.08136)] [[Code](https://github.com/LE-Mamba/LE-Mamba)] ![Stars](https://img.shields.io/github/stars/LE-Mamba/LE-Mamba)
- **Seg-LSTM: Sequential LSTM for Remote Sensing Image Segmentation with State Space Model** - February 14, 2024, arXiv [[Paper](https://arxiv.org/abs/2402.06274)] [[Code](https://github.com/Seg-LSTM/Seg-LSTM)] ![Stars](https://img.shields.io/github/stars/Seg-LSTM/Seg-LSTM)
- **VMRNN: Vision Mamba RNN for Sequential Remote Sensing Image Processing** - February 9, 2024, arXiv [[Paper](https://arxiv.org/abs/2402.05756)] [[Code](https://github.com/VMRNN/VMRNN)] ![Stars](https://img.shields.io/github/stars/VMRNN/VMRNN)
